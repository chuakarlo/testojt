define( function ( require ) {
	...
	describe( 'Objectives Test', function () {

		it( 'should exist on App.Entities', function () {
			App.should.have.property( 'Entities' );
			App.Entities.should.have.property( 'ObjectivesTitle' );
		} );

		describe( 'when initialized ObjectivesTitle', function () {

			var model;

			before( function () {
				model = new App.Entities.ObjectivesTitle();
			} );
			...
			it( 'should have property getReadOptions and return options', function () {
				...
				options.method.should.equal( 'getIndividualFocusObjectivesTitles' );
			...
			it( 'should have property path', function () {
				...
				model.path.should.equal( 'SessionService' );
			} );

		} );

		describe( 'when initialized ObjectivesContent', function () {

			var model;

			before( function () {
				model = new App.Entities.ObjectivesContent();
			} );
			...
			it( 'should have property getReadOptions and return options', function () {
				...
				options.should.have.property( 'method' );
				options.method.should.equal( 'getIndividualFocusObjectivesSubstandardsAndContent' );

				options.should.have.property( 'args' );
				options.args.should.have.property( 'NCESId' );
				options.args.should.have.property( 'STATESTDID' );
				options.args.should.have.property( 'persId' );
			} );
		...
		describe( 'when requesting `lt:objectivestitle`', function () {

			var result;
			var ajax;

			var fetch = function ( done ) {
				var fetching = App.request( 'lt:objectivestitle' );
			...
			describe( 'and an error occurs', function () {
				...
				it( 'should return an error message', function () {
					...
					result.message.should.equal( 'Error fetching focus objectives' );
				} );
			...
			describe( 'and returns successfully', function () {
				...
				it( 'should return ObjectivesTitle', function () {
					result.should.be.an.instanceof( App.Entities.ObjectivesTitle );
				} );
