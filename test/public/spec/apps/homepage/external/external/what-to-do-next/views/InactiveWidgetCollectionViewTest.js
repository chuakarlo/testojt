define( function ( require ) {
	...
	describe( 'InactiveWidgetCollectionView CollectionView', function () {
		...
		before ( function () {
			var InactiveWidgetCollectionView = require( 'external/external/what-to-do-next/views/InactiveWidgetCollectionView' );
			var WidgetCollection             = require( 'external/external/what-to-do-next/collections/WidgetCollection' );
			var manifest                     = require( 'external/external/what-to-do-next/manifest' );
