define ( function ( requir ) {
	...
	var WidgetItemView         = require( 'external/external/what-to-do-next/external/learning-targets/views/WidgetItemView' );
	var InactiveWidgetItemView = require( 'external/external/what-to-do-next/external/learning-targets/views/InactiveWidgetItemView' );
	var base                   = require( 'external/external/what-to-do-next/external/learning-targets/base' );
	var expect                 = require( 'chai' ).expect;

	describe( 'baseTest for Learning Targets', function () {
