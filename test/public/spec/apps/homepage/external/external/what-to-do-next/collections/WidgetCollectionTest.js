define( function ( require ) {
	...
	var Collection  = require( 'external/external/what-to-do-next/collections/WidgetCollection' );
	var WidgetModel = require( 'external/external/what-to-do-next/models/WidgetModel' );
