define ( function ( requir ) {
	...
	var WidgetItemView         = require( 'external/external/what-to-do-next/external/whats-new/views/WidgetItemView' );
	var InactiveWidgetItemView = require( 'external/external/what-to-do-next/external/whats-new/views/InactiveWidgetItemView' );
	var base                   = require( 'external/external/what-to-do-next/external/whats-new/base' );
	var expect                 = require( 'chai' ).expect;

	describe( 'baseTest for What\'s New', function () {
