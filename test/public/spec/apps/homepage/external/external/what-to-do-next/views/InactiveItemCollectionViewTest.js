define( function ( require ) {
	...
	describe( 'InactiveItemCollectionView CollectionView', function () {
		...
		before ( function () {
			var InactiveItemCollectionView = require( 'external/external/what-to-do-next/views/InactiveItemCollectionView' );
			var WidgetCollection     = require( 'external/external/what-to-do-next/collections/WidgetCollection' );
			var parent                = [];
			require( 'external/external/what-to-do-next/external/group-activity/base' ).register( parent, {} );
