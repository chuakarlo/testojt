...
define( function ( require ) {
	...
	describe( 'ContentItemCollectionView CollectionView ', function () {
		before ( function () {
			var ContentItemCollectionView = require ( 'external/external/content/views/ContentItemCollectionView' );
		...
		it ( 'should have a itemView', function () {
			var ContentItemView = require( 'external/external/content/views/ContentItemView' );
