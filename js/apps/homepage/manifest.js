define( function ( require ) {
	...
	return function ( ) {
		...
		// var contentMessages = require( 'text!apps/homepage/external/content2/configuration/messages.json' );
		...
		// require( 'apps/homepage/external/content2/base' ).register( parent, sharedData, function () {
