define( function ( require ) {
	...
	var template      = require( 'text!groups/templates/wall/groupCommentsView.html' );
	var usersTemplate = require( 'text!groups/templates/wall/usersGroupCommentsView.html' );
	var newsTemplate  = require( 'text!groups/templates/wall/NewsItemView.html' );

	var GroupCommentView   = require( 'groups/views/wall/GroupCommentView' );
	...
	return Marionette.CompositeView.extend( {
		...
		'templateHelpers' : {
			...
			'getNewsEntry' : function () {
				return autolinker.link( this.NewsEntry );
			}
